...
//================================================
/*
 * function used to make the uploading work and to
 * check if the upload is actually an immage.
 * This function then sends it to the database.
 */    
//================================================
...
// if everything is ok, try to upload file
        ...
        if ($result)
        {
                echo '<h3>The file ". basename( $_FILES["fileToUpload"]["name"]). 
                    " has been uploaded.</h3>
                    <img src="'.$target_file.'" /><br>
                    <a href="'.$target_file.'" target="_blank">
                    Show in new tab</a><br>
                    <a href="'.$target_file.'" download=
                    "'.basename( $_FILES["fileToUpload"]["name"]).'">Download</a><br>';
        } 
        else 
        {
